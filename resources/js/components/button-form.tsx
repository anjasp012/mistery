...
export default function ButtonForm({ button }: ButtonProps) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('admin.button.update', button.slug), {
            preserveScroll: true,
            onSuccess: () => {
                ...
                <>
                    <TableRow>
                        ...
                        <TableCell><img onClick={e => {setOpen(true)
                             setImageDialog(`/storage/${button.file}`)} } className='w-10' src={`/storage/${button.file}`} alt={button.file} /></TableCell>
